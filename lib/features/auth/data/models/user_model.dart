...
class UserModel extends User {
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    // marketStaffInfo removed for DeliveryStaff
    ...
    return UserModel(
      ...
      roleId: _parseRoleId(json['roleId']),
  ...
  static int _parseRoleId(dynamic roleId) {
    if (roleId is int) return roleId;
    if (roleId is String) return int.tryParse(roleId) ?? 0;
    return 0;
  }
